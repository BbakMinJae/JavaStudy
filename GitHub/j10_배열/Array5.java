...
public class Array5 {
	public static void main(String[] args) {
		...
		students[0] = new Student("홍길동", 3, 18, "부산 동래구", "010-3300-4698");
		students[1] = new Student("오재근", 2, 17, "부산 금정구", "010-1234-5678");
		students[3] = new Student("성시원", 1, 16, "부산 진구", "010-1111-2222");
